...
@section('content')
        ...
        <form action="{{ route('store.student') }}" method="post" enctype="multipart/form-data">
            ...
            <input type="text" id="roll" name="roll" value="{{ old('roll') }}" required>
            ...
            <label for="assign_class">Assign Class:</label>
            <input type="text" id="assign_class" name="assign_class" placeholder="Select Class" required>

            <label for="student_parent">Student's Parent:</label>
            <input type="text" id="student_parent" name="student_parent" placeholder="Select Parent" required>
